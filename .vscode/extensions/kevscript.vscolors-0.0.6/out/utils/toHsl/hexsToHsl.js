...
exports.hexaToHsl = exports.hexaToHsla = exports.hexToHsla = exports.hexToHsl = void 0;
const vscode = require("vscode");
const formatHsls_1 = require("../format/formatHsls");
// HEX TO HSL
function hexToHsl(clr) {
...
// HEX TO HSLA
function hexToHsla(clr) {
    const hsl = hexToHsl(clr);
    const formattedHsl = formatHsls_1.formatHsl(hsl);
...
//# sourceMappingURL=hexsToHsl.js.map